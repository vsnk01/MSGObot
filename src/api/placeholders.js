...
export const applicationHeader = (username) => `Заявка на вступление от @${username}\n\n`; 
...
export const leftChatText = (username) => `${username}
покинули чат.
Диалог завершён и ваши сообщения не будут отправлены.`;

export const joinChatText = (username) => `${username}
присоединился к чату. Следующие сообщения будут
отправлены этому пользователю.`;
