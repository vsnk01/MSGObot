...
export const helpText = (role) =>
                        ...
                        */start - Запуск бота или выход в главное меню*
                        */help - показать список комманд*
                        ...
                        `*Просмотр заявок - вы можете просмотреть все заявки за определённый период и дать на них ответ.*
                        *Получение заявок в режиме реального времени - успейте ответить на свежую заявку сразу!*
                        *Рассылка - отправка сообщения всем пользователям, подписаных на бота*`

                        :

                        `*Подача заявки - быстрый и лёгкий способ отправить заявку.*
                        *Сопровождаеться сбором основных данных*
                        *FAQ - список часто задаваемых вопросов с ответами на них. Вся важная информация здесь!*`

                        }
                        
                        **Есть вопросы? Свяжитесь с @fukuro_dz**`;
...
Хочешь присоединиться к команде? Тогда давай начнём!
